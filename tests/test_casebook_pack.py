"""Regression checks for the copper-dev-deps-deck casebook."""
...
from casebook.harness import assert_expected, copper_dev_deps_deck_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_dev_deps_deck_summary(), assert_expected())
